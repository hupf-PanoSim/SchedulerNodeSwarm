...
#pragma pack(pop)
    ...
    //////////////////////////////////////////////////////////////////////////
    const char* const LIDAR_OBJLIST_G_FORMAT = "time@i,1024@[,OBJ_ID@i,OBJ_Class@b,OBJ_S_X@d,OBJ_S_Y@d,OBJ_S_Z@d,OBJ_S_Dist@d,"
        "OBJ_S_Azimuth@d,OBJ_S_Elevation@d,OBJ_Ego_Vx@d,OBJ_Ego_Vy@d,OBJ_Ego_Heading@d,OBJ_Length@d,OBJ_Width@d,OBJ_Height@d";
